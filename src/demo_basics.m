...
%%
    ...
    X_opt             = Functional_Map.groundtruth_functional_map(source_basis, target_basis, correspondences);
    
%%        
    gt_map = (1:mesh1.num_vertices)';   % Ground truth correspondences from Source_Mesh to Target_Mesh.    
%     [dists,  random_points]  = Functional_Map.pairwise_distortion_of_map(X_opt, mesh1, mesh2, source_basis, target_basis, gt_map, 'nsamples', 20, 'fast');   
%%     
